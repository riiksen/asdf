...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Asdf web application."
  #
  #
  ...
  #
  # settings.secret_key_base= nY9ONtcm0VqgKC2E8nCplrQ_wNiU0n3iNxyqAC-klao
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("asdf.log", "w"))
  #
  #
end
